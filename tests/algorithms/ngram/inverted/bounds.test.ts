...
import { assertAddressable } from '../../../../src/algorithms/shared/ngram/inverted/builder.js'
import {
  assertCosineExact,
  assertCosineNormsExact,
} from '../../../../src/algorithms/shared/ngram/inverted/cosine.js'
import {
  assertDiceAccumulatorExact,
  createDiceIndexBuilder,
} from '../../../../src/algorithms/shared/ngram/inverted/dice.js'
import { createScorer } from '../../../../src/core/scoring/scorer.js'
import { indexOf, pairs } from './support.js'
